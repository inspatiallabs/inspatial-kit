...
import { View, Slot, XStack, YStack, Stack } from "@inspatial/kit/structure";
  ...
  return (
    <>
      ...
      >
        ...
        <View scrollable data-inmotion="fade-u duration-500 once" zIndex={100}>
          <Slot className="flex flex-col justify-center items-center gap-10">
            ...
            <Show
              when={$(() => explicitDemoState.activeDemo.get() === "config")}
            >
            ...
            <Show
              when={$(() => unifiedState.unifiedSection.get() === "action")}
            >
            ...
            <Show
              when={$(() => unifiedState.unifiedSection.get() === "trigger")}
            >
