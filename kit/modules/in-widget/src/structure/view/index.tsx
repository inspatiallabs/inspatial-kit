...
function animateIn(
  ...
  try {
    ...
    console.warn("View animation failed:", error);
    node.style.opacity = "1";
    node.style.transform = "";
  }
}
  ...
  function mountView() {
    ...
    requestAnimationFrame(() => {
      try {
        ...
        console.warn("View mount animation error:", error);
      }
    });
  }
