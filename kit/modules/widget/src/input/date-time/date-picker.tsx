...
// import { format, type Locale, isValid } from "date-fns";
// import { enUS } from "date-fns/locale";
// import { tv, VariantProps } from "tailwind-variants";
// import { BiMinus } from "rocketicons/bi";
// import { TiCalendar } from "rocketicons/ti";

// import { kit, focusInput, focusRing, hasErrorInput } from "@/inspatial/util";

// import { DateTime } from "@/components/ui/DateTime/date-time";
// import { type Matcher } from "./date-utils";
...
//         aria-hidden="true"
//         className={kit(
//           "pointer-events-none block w-full text-left text-muted sm:text-sm",
//           {
...
//         <button
//           ref={forwardedRef}
//           className={kit(triggerStyles({ hasError }), className)}
//           {...props}
//         >
//           <TiCalendar className="size-5 shrink-0 text-muted" />
...
// // Create a wrapper function to handle multiple Matchers
// const createCombinedMatcher = (
...
//   ) => {
//     // If selected is a range object, extract its 'from' date
//     const newDate = selected instanceof Date ? selected : selected?.from;
...
//                 selected={date}
//                 onSelect={onDateChange}
//                 disabled={createCombinedMatcher(disabledDays)}
//                 locale={locale}
...
//     selected: Date | { from: Date; to?: Date } | undefined
//   ) => {
//     // Handle when selected is not a range object
//     if (selected instanceof Date) {
//       // If a single date is selected, convert it to a range
//       const newRange: DateRange = { from: selected };
//       setRange(newRange);
//       return;
//     }

//     // Now handle when selected is a range object
...
//         setRange({ ...range, from: updatedFrom });
//       }
//     } else {
//       setEndTime(time);
//       if (range?.to) {
//         const updatedTo = new Date(range.to);
//         updatedTo.setHours(time.hour);
//         updatedTo.setMinutes(time.minute);
//         setRange({ ...range, to: updatedTo });
//       }
//     }
//   };
...
//                     />
//                   </div>
//                   <BiMinus className="size-4 shrink-0 text-gray-400" />
//                   <div className="flex flex-1 items-center gap-x-2">
//                     <span className="dark:text-gray-30 text-gray-700">
