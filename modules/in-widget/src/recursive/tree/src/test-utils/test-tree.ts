import { beforeEach, describe, spy, FakeTime } from "@in/test";
import type { TreeConfig, TreeInstance } from "../types/core.ts";
import type { TreeDataLoader } from "../features/sync-data-loader/types.ts";
import { createTreeCore } from "../core/create-tree.ts";
import { TestTreeDo } from "./test-tree-do.ts";
import { TestTreeExpect } from "./test-tree-expect.ts";
import { syncDataLoaderFeature } from "../features/sync-data-loader/feature.ts";
import { asyncDataLoaderFeature } from "../features/async-data-loader/feature.ts";
import { buildProxiedInstance } from "../core/build-proxified-instance.ts";
...
export class TestTree<T = string> {
  ...
  get instance() {
    if (!this.treeInstance) {
      this.treeInstance = createTreeCore(this.config);
  ...
  async runWhileResolspyngItems(cb: () => Promise<void>) {
