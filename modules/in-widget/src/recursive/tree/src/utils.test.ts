...
import { makeStateUpdater, memo, poll } from "./utils.ts";
...
describe("utilities", () => {
  describe("memo", () => {
    it("returns same value for same arguments", () => {
      ...
      const memoized = memo((c: number, d: number) => [1, 1, c, d], fn as any);
