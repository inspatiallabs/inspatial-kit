...
import type { ItemMeta } from "../features/tree/type.ts";
import { treeFeature } from "../features/tree/feature.ts";
import { buildStaticInstance } from "./build-static-instance.ts";
import { throwError } from "../utilities/errors.ts";
