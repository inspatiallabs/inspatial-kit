...
import { Button, type ButtonProps } from "../../ornament/button/index.ts";
...
import { Tab, TabProps } from "../../ornament/index.ts";
import { PlusIcon } from "../../icon/plus-icon.tsx";
...
export function TableList({
  ...
  if (each) {
    const { lazy } = require("../../performance/lazy/index.ts");
    const List = lazy(
      () => import("../../data-flow/list/core.ts"),
      "List"
    );
    return (
      <tbody
