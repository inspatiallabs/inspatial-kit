...
```bash
deno install jsr:@in/route
```

##

```bash
npx jsr add @in/route
```

##

```bash
yarn dlx jsr add @in/route
```

##

```bash
pnpm dlx jsr add @in/route
```

##

```bash
bunx jsr add @in/route
```

##

```bash
vlt install jsr:@in/route
```
---
...
We welcome contributions to InRoute! Please read our [Contributing Guidelines](CONTRIBUTING.md) to get started.
...
<div align="center">
  <strong>Ready to build the future of routing?</strong>
  <br>
