...
```bash
yarn dlx jsr add @in/ssr
```

##

```bash
pnpm dlx jsr add @in/ssr
```
...
We welcome contributions to InSSR! Please read our [Contributing Guidelines](CONTRIBUTING.md) to get started.
...
<div align="center">
  <strong>Ready to build the future of the Server Side Rendering?</strong>
  <br>
