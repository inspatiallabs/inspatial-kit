...
InDOM is a high-performance, DOM-less environment designed for universal rendering across web, native, embedded and XR applications.
...
We welcome contributions to InDOM! Please read our [Contributing Guidelines](CONTRIBUTING.md) to get started.
...
<div align="center">
  <strong>Ready to build the future of the DOM Rendering?</strong>
  <br>
