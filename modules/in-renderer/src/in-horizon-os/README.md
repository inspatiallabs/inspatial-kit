...
```bash
deno install jsr:@in/horizon-os
```

##

```bash
npx jsr add @in/horizon-os
```

##

```bash
yarn dlx jsr add @in/horizon-os
```

##

```bash
pnpm dlx jsr add @in/horizon-os
```

##

```bash
bunx jsr add @in/horizon-os
```

##

```bash
vlt install jsr:@in/horizon-os
```
...
We welcome contributions to InHorizonOS! Please read our [Contributing Guidelines](CONTRIBUTING.md) to get started.
...
<div align="center">
  <strong>Ready to build the future of Horizon OS Rendering?</strong>
  <br>
