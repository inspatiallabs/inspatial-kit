import { bgGreen, bgRed, bold, gray, green, red, white } from "@in/style";
import type { DiffResultProp, DiffTypeProp } from "@in/vader/difference";
...
export function buildMessage(
  ...
  const messages = [
    ...
    gray("━".repeat(50)),
    "",
    `    ${gray(bold("⚡️ Compare:"))} ${red(bold("Actual"))} ${gray(
      "vs"
    )} ${green(bold("Expected"))}`,
    gray("┄".repeat(50)),
    "",
