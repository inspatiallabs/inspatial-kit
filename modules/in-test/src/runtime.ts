...
import { formatTestName } from "./shared.ts";
...
export function createDenoTest(): Runner {
  const test = (
    ...
    if (typeof nameOrConfig === "object") {
      return Promise.resolve(
        (globalThis as any).InZero.test({
          name: formatTestName(nameOrConfig.name),
          fn: nameOrConfig.fn,
    ...
    return Promise.resolve(
      (globalThis as any).InZero.test({
        name: formatTestName(nameOrConfig),
        fn: fnOrUndefined!,
        ...options,
      })
    );
...
export function createBunTest(): Runner {
  const test = (
    ...
    if (typeof nameOrConfig === "object") {
      return Promise.resolve(
        bun
          .jest(caller())
          .test(
            formatTestName(nameOrConfig.name),
            nameOrConfig.fn,
            nameOrConfig.options
          )
      );
    ...
    return Promise.resolve(
      bun.jest(caller()).test(formatTestName(nameOrConfig), fnOrUndefined!, options)
    );
  };
  ...
  test.only = (
    ...
    if (typeof nameOrConfig === "object") {
      return Promise.resolve(
        bun
          .jest(caller())
          .test.only(formatTestName(nameOrConfig.name), nameOrConfig.fn, {
            ...nameOrConfig.options,
            only: true,
          })
      );
    ...
    return Promise.resolve(
      bun.jest(caller()).test.only(formatTestName(nameOrConfig), fnOrUndefined!, {
        ...options,
        only: true,
      })
    );
  ...
  test.skip = (
    ...
    if (typeof nameOrConfig === "object") {
      return Promise.resolve(
        bun
          .jest(caller())
          .test.skip(formatTestName(nameOrConfig.name), nameOrConfig.fn, {
            ...nameOrConfig.options,
            skip: true,
          })
      );
    ...
    return Promise.resolve(
      bun.jest(caller()).test.skip(formatTestName(nameOrConfig), fnOrUndefined!, {
        ...options,
        skip: true,
      })
    );
  ...
  test.todo = (
    ...
    if (typeof nameOrConfig === "object") {
      return Promise.resolve(
        bun.jest(caller()).test.todo(formatTestName(nameOrConfig.name), todoFn, {
          ...nameOrConfig.options,
          ...options,
          todo: true,
        })
    ...
    return Promise.resolve(
      bun.jest(caller()).test.todo(formatTestName(nameOrConfig), todoFn, {
        ...options,
        todo: true,
      })
    );
...
export function createNodeTest(): Runner {
  const test = (
    ...
    if (typeof nameOrConfig === "object") {
      ...
      return Promise.resolve(node.test(formatTestName(nameOrConfig.name), testFn));
    }
    // Converts test function to Node's expected format
    const testFn = (_t: any) => fnOrUndefined!();
    return Promise.resolve(node.test(formatTestName(nameOrConfig), testFn));
  };
  ...
  test.only = (
    ...
    if (typeof nameOrConfig === "object") {
      const testFn = (_t: any) => nameOrConfig.fn();
      return Promise.resolve(node.test.only(formatTestName(nameOrConfig.name), testFn));
    }
    const testFn = (_t: any) => fnOrUndefined!();
    return Promise.resolve(node.test.only(formatTestName(nameOrConfig), testFn));
  };
  ...
  test.skip = (
    ...
    if (typeof nameOrConfig === "object") {
      const testFn = (_t: any) => nameOrConfig.fn();
      return Promise.resolve(node.test.skip(formatTestName(nameOrConfig.name), testFn));
    }
    const testFn = (_t: any) => fnOrUndefined!();
    return Promise.resolve(node.test.skip(formatTestName(nameOrConfig), testFn));
  };
  ...
  test.todo = (
    ...
    if (typeof nameOrConfig === "object") {
      return Promise.resolve(node.test.todo(formatTestName(nameOrConfig.name), todoFn));
    }
    return Promise.resolve(node.test.todo(formatTestName(nameOrConfig), todoFn));
  };
