 ...
 * @example
 * const code: CurrencyCoder = "USD"; // Valid
 * const invalid: CurrencyCoder = "XXX"; // Type error
 */
export type CurrencyCoder = (typeof CURRENCY_CODES)[number];
...
export function getCurrency(code: CurrencyCoder): CurrencyInfo | undefined {
 ...
 * @param {CurrencyCoder} currencyCode - The currency code to use (defaults to "GBP")
...
export function formatCurrencyInput(
  value: string,
  currencyCode: CurrencyCoder = "GBP"
): string {
